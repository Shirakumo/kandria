  ...
  (let* ((player (unit 'player T))
    ...
    (loop for (level x y . materials) in
          '((1 100 150 (1 item:rusted-clump) (50 item:parts) (2 item:silver-ore))
            ...
            (3 500 150 (500 item:parts) (5 item:gold-nugget) (1 item:coolant) (2 item:thermal-fluid))
            (4 700 150 (1000 item:parts) (10 item:gold-nugget) (10 item:coolant) (2 item:thermal-fluid))
            (5 900 150 (2000 item:parts) (20 item:gold-nugget) (2 item:pearl) (3 item:hardened-alloy) (3 item:coolant) (2 item:refined-oil)))
