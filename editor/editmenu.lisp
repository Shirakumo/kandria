...
(alloy::define-subbutton (editmenu save-init) ("Save Initial State") (edit 'save-initial-state T))
(alloy::define-subbutton (editmenu select) ("Select") (edit 'select-entity T))
...
(alloy:define-subcontainer (editmenu layout :if-exists :supersede)
  ...
  new save load save-init select zoom undo redo lighting time)
