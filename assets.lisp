...
(define-assets-from-path (sound trial-harmony:sound "**/*.wav")
  ...
  (fishing-begin-jingle :volume (db -2))
  (fishing-bad-catch :volume (db -2))
  (fishing-good-catch :volume (db -2))
  ...
  (mech-step-1 :volume (db 0.0))
  (mech-step-2 :volume (db 0.0))
  (mech-jump :volume (db 0.0))
  (mech-bash :volume (db 0.0))
