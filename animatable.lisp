...
(defmethod hurt :around ((animatable animatable) attacker)
...
(defmethod hurt ((animatable animatable) attacker)
  (let ((damage (damage-output attacker)))
