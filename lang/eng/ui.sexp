...
dont-send-error-reports "Don't send report on crash"
...
show-startup-logos "Show startup logos"
open-config-dir "Open config directory"
change-module-directory "Change module directory"
open-cheat-menu "Open cheat menu"
generic-proceed-button "Go"
generic-success-notice "Success"
generic-working-notice "Working..."
generic-failure-notice "Failed"
...
module-uninstall-confirm "Are you sure you want to uninstall the mod? This will delete all local files for it!"
module-update "Update"
module-already-installed "Installed"
...
module-logged-in-status "Logged in as ~a"
module-logged-out-status "Not logged in"
module-offline-status "Offline"
module-logout-prompt "Do you want to log out?"
module-world-completed-title "World Complete!"
module-world-completed-description "Congratulations, you've completed ~s by ~a!"
module-replay-current-world "Replay World"
module-proceed-to-next-world "Next World"
module-open-source-directory "Open Source Directory"
module-select-preview-image "Select Mod Preview Image"
module-enter-title "Enter the mod title"
module-install-completed "~a installed"
...
error-module-install-failed "Failed to install the module~@[: ~a~]"
