...
fish:machine-fish/description "A child's toy or a naval weapon? I'm genuinely not sure."
fish:salmon "Salmon"
...
fish:can-fish/description "Either this fish got stuck inside this can, or it decided to wear it for armour."
fish:tire "Old Tyre"
...
fish:boot-crate/description "Filled with sludge and highly-unfashionable to boot."
fish:megaroach "Megaroach"
fish:megaroach/description "I think this was also a common android insult."
fish:roach "Cockroach"
fish:roach/description "Naturally this guy survived the apocalypse."
fish:seaweed "Seaweed"
fish:seaweed/description "Slimy but healthy. Revolting but moreish. Does not compute."
...
fish:three-eyed-fish/description "Sometimes fish are weird."
fish:gyofish "Gyofish"
fish:gyofish/description "It smells horrendous."
...
fish:sand-dollar/description "I prefer the name sea cookie."
fish:clam "Clam"
fish:clam/description "Doesn't bite - well it closes, but very slowly. But then how did it take the bait?"
...
fish:blobfish/description "If you put a human being at a depth of 4,000 feet, they'd probably look like this too." ;; https://www.smithsonianmag.com/smart-news/in-defense-of-the-blobfish-why-the-worlds-ugliest-animal-isnt-as-ugly-as-you-think-it-is-6676336/
fish:jellyfish "Jellyfish"
fish:jellyfish/description "It's an alien. It has to be."
fish:squid "Squid"
fish:squid/description "Can squirt ink and change colour. So like a multicolour pen."
...
fish:leaflet/description "The ink has washed away, but I can just make out a sunset."
fish:shell "Shell"
fish:shell/description "If I raise this to my ear I can hear the sea. How?" ;; suggests androids have fluid rushing near their ear canals too
fish:trout "Trout"
fish:trout/description "People used to hunt these for sport."
...
fish:anglerfish/description "I would love to see one of these hook a fisherman."
fish:action-figure "Action Figurine"
fish:action-figure/description "It resembles an early robot design. Thank God aesthetics moved beyond this."
...
fish:swordfish2/description "Sometimes nature just has the best ideas for weapons."
fish:nameplate "Ship Nameplate"
fish:nameplate/description "The name has faded."
fish:car-battery "Car Battery"
fish:car-battery/description "A chemical battery once used in pre-electric cars."
fish:seahorse "Seahorse"
fish:seahorse/description "I always wanted a horse; this is not quite what I had in mind though."
fish:trilobite "Trilobite"
fish:trilobite/description "Sort of resembles a fossilised marine beetle."
fish:rubber-duck "Rubber Duck"
fish:rubber-duck/description "A strange human creation without any discernible purpose."
fish:toy-submarine "Toy Submarine"
fish:toy-submarine/description "If only we could all live in this."
fish:alligator "Alligator"
fish:alligator/description "It's definitely not a crocodile - it's all in the shape of the snout."
;; UI
