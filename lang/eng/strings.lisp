...
item:small-health-pack/description "[Heals 10HP] A hodgepodge of circuit boards, clipped wires, and rolls of solder to meet my repairing needs." ;; TODO if player starts final game with some, don't say Sahil made it; otherwise do
item:medium-health-pack "Medium Health Pack"
item:medium-health-pack/description "[Heals 25HP] Like a small health pack, but contains more stuff."
item:large-health-pack "Large Health Pack"
item:large-health-pack/description "[Heals 50HP] Use this to avoid spending another few decades offline."
...
item:bolt "Bolt"
item:bolt/description "Useless without a nut of the same diameter. Unless you like tiddlywinks."
item:nut "Nut"
item:nut/description "Pair with a bolt to secure heavy things together. Tidier and more reusable than a screw."
item:gear "Gear"
item:gear/description "I have many gear trains inside me, with some cogs even smaller than this."
...
item:metal-ring/description "This could have come from practically anything. The only thing I can say for certain is that given its diameter, it was never a wedding ring."
item:broken-ring "Broken Ring"
item:broken-ring/description "A broken token, waiting to one day be reunited with its other half? No."
...
item:simple-gadget/description "Was once a consumer device, like a calculator or a toy."
item:dented-plate "Dented Plate"
item:dented-plate/description "I think this was military armour, like the kind you might find on a tank."
item:simple-circuit "Simple Circuit"
item:simple-circuit/description "An electronic circuit board that used to be found in most appliances, from washing machines to smartphones."
...
item:broken-circuit/description "Nothing a deft hand and a soldering iron couldn't fix."
item:large-battery "Large Battery"
item:large-battery/description "A large chemical battery, like those once found in electric vehicles. Thank God I don't need to cart one of these around."
item:small-battery "Small Battery"
item:small-battery/description "Once powered a home appliance. It's dead."
item:coin "Old Coin"
...
item:controller/description "Used to interface with a video game console. I miss video games."
...
item:memory/description "This is pre-pre-Calamity. Can you imagine storing data on something so easily misplaced? I'm glad they found a better solution for androids."
...
item:dirt-clump/description "I could claw one of these out from any of the caves around here. The convenience here is that someone or something already did this."
...
item:pure-water/description "Someone distilled this water to remove impurities."
