...
toggle-menu/description "Opening the menu gives you access to the inventory, quest logs, and more"
report-bug "Reporting Bugs"
report-bug/description "Should you encounter a problem, or have feedback to share, use the feedback form!"
quickmenu "Quick Item Menu"
quickmenu/description "Use the quick menu to access healing items and help yourself out of a jam"
save "Saving"
save/description "Use a phone box to save your progress. You can also save from the menu if you're near a phone box"
attack "Attacking"
attack/description "Attacks can be combined with directions for different effect"
;; Items
