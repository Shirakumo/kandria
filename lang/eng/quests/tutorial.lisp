...
(define-sequence-quest (kandria tutorial)
  ...
  (:eval
   ...
   (dolist (unit '(catherine fi jack trader alex innis islay zelah semi-engineer-chief cerebat-trader-quest soldier-1 soldier-2 soldier-3 semi-roboticist semi-barkeep semi-patron-1 semi-patron-2 semi-partner cerebat-partner))
