...
| And if the Wraw have marched as far as the Cerebats, then the Semi Sisters are next.
| (:annoyed)Now is not the time for division - the Wraw are a threat to them as much as they are to us.
| (:normal)Use whatever sway you have with \"Innis and Islay\"(orange) and \"ask them to stand with us\"(orange).
~ player
- Got it.
