...
(define-sequence-quest (kandria demo-start)
  ...
  (:eval
   ...
   (dolist (unit '(innis islay zelah semi-engineer-chief cerebat-trader-quest semi-roboticist semi-barkeep semi-patron-1 semi-patron-2 semi-partner cerebat-partner))
  ...
  (:animate (player wake-up)
    (save-state +main+ T))
  (:interact (NIL :now T) :source "demo-start")
  (:eval
